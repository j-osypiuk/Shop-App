...
import com.example.orderproduct.OrderProductRepository;
...
class OrderServiceImplTest {
    ...
    void saveOrderWithExistingAddressSavesOrder() throws ObjectNotFoundException, InvalidStateException {
        ...
        given(productRepository.findById(foundProduct2.getProductId())).willReturn(Optional.of(foundProduct2));
        ...
        ArgumentCaptor<Long> productsIdCaptor = ArgumentCaptor.forClass(Long.class);
        ...
        assertThat(productsIdCaptor.getAllValues().get(0)).isEqualTo(foundProduct1.getProductId());
        assertThat(productsIdCaptor.getAllValues().get(1)).isEqualTo(foundProduct2.getProductId());
