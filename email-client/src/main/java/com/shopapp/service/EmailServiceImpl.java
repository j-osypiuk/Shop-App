...
public class EmailServiceImpl implements EmailService{
    ...
    public EmailServiceImpl(JavaMailSender javaMailSender, Configuration config) {
        this.javaMailSender = javaMailSender;
        this.config = config;
    }

    public void sendMail(String toEmail, MailDetails mailDetails) {
        ...
        try {
            ...
            String html = FreeMarkerTemplateUtils.processTemplateIntoString(template, mailDetails);
